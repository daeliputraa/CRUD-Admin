...
<html lang="en">
  ...
  <body>
    ...
    <div id="sidebar" class="row mt-5">
      ...
      // mengambil data mahasiswa,dosen,pegawai
      ...
      // menghitung data mahasiswa,dosen,pegawai
      ...
      <div id="mainbar" class="col-md-10 p-5 main-content">
        <h3 data-aos="fade-in" data-aos-duration="2000"><i class="bi bi-speedometer"></i>Dashboard</h3>
        <hr />
        <div class="row text-white">
          <div class="card card-mahasiswa ms-5" style="width: 18rem" data-aos="fade-up" data-aos-duration="1000">
            <div class="card-body">
              <div class="icon">
                <i class="bi bi-mortarboard-fill"></i>
              </div>
              <h5 class="card-title">Jumlah Mahasiwa</h5>
              <div class="display-4"><?php echo $jumlah_mahasiswa; ?></div>
              <a href="mahasiswa.php"
                ><p class="card-text">Lihat Detail <i class="bi bi-chevron-double-right ms-2"></i></p
              ></a>
            </div>
          </div>
          <div class="card card-dosen ms-5" style="width: 18rem" data-aos="fade-up" data-aos-duration="1300">
            <div class="card-body">
              <div class="icon">
          ...
          <div class="card card-pegawai ms-5" style="width: 18rem" data-aos="fade-up" data-aos-duration="1600">
            <div class="card-body">
              <div class="icon">
