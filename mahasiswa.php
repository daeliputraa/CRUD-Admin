  ...
  <body>
    ...
    <div id="sidebar" class="row mt-5">
      ...
      <div id="mainbar" class="col-md-10 p-5 main-content">
        <div class="row">
        <div class="col-md-8">
        <h3 data-aos="fade-in" data-aos-duration="2000"><i class="bi bi-mortarboard-fill"></i>Daftar Mahasiswa</h3>
        </div>
        <div class="col-md-4 ms-1" >
        <a href="createmahasiswa.php" class="btn btn-detail ms-auto" data-aos="fade-in" data-aos-duration="2000"><i class="bi bi-plus-square"></i>Tambah Mahasiswa</a>
        </div>
        </div>
        <hr />
          ...
          <?php
            ...
            <tr>
              ...
              <td class="text-center">
                <a href="updatemahasiswa.php?id=<?= $row['id']; ?>" class="btn btn-edit">Edit</a>
                <a href="deletemahasiswa.php?id=<?= $row['id']; ?>" class="btn btn-hapus" onclick="return confirm('Hapus Data?');">Hapus</a>
              </td>
            </tr>
            <?php $no++; } ?>
          </tbody>
