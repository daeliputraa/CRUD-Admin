      ...
      <div id="mainbar" class="col-md-10 p-5 main-content">
        ...
        <?php
				...
				if (isset($_POST['submit'])) {
					...
					mysqli_query($koneksi, "update dosen set nama='$nama', nik='$nik', lahir='$lahir', alamat='$alamat' where id ='$id'") or die(mysqli_error($koneksi));

					//redirect ke halaman index.php
					echo "<script>alert('Data Berhasil Perbaharui.');window.location='dosen.php';</script>";
				}
