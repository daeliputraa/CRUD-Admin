  ...
  <body>
    ...
    <div id="sidebar" class="row mt-5">
      ...
      <div id="mainbar" class="col-md-10 p-5 main-content">
        <h3 data-aos="fade-in" data-aos-duration="2000"><i class="bi bi-pencil-square"></i>Form Edit</h3>
        <hr />
        ...
        <form  action="" method="post" role="form" data-aos="fade-up" data-aos-duration="1000">
          ...
          <?php
				...
				?>
            <!-- ini digunakan untuk menampung id yang di ubah -->
          ...
          <div class="mb-3">
            <label for="nik" class="form-label">NPM</label>
            <input type="text" class="form-control" name="nik" value="<?= $row['nik']; ?>">
          </div>
          <div class="mb-3">
            <label for="lahir" class="form-label">Tanggal Lahir</label>
            <input type="text" class="form-control" name="lahir" value="<?= $row['lahir']; ?>">
          </div>
          <div class="mb-3">
            <label for="alamat" class="form-label">Alamat</label>
            <input type="text" class="form-control" name="alamat" value="<?= $row['alamat']; ?>">
          </div>
          <button type="submit" name="submit" value="simpan"><a class="btn btn-detail">Perbaharui</a></button>
        ...
        <?php
				...
				if (isset($_POST['submit'])) {
					...
					mysqli_query($koneksi, "update pegawai set nama='$nama', nik='$nik', lahir='$lahir', alamat='$alamat' where id ='$id'") or die(mysqli_error($koneksi));

					//redirect ke halaman index.php
					echo "<script>alert('Data Berhasil Perbaharui.');window.location='pegawai.php';</script>";
				}
