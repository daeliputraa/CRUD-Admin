  ...
  <body>
    ...
    <div id="sidebar" class="row mt-5">
      ...
      <div id="mainbar" class="col-md-10 p-5 main-content">
        <div class="row">
        <div class="col-md-8">
        <h3 data-aos="fade-in" data-aos-duration="2000"><i class="bi bi-people-fill"></i>Daftar Dosen</h3>
        </div>
        <div class="col-md-4 ms-1" >
        <a href="createdosen.php" class="btn btn-detail ms-auto" data-aos="fade-in" data-aos-duration="2000"><i class="bi bi-plus-square"></i>Tambah Dosen</a>
        </div>
        </div>
        <hr />
        <table class="table table-striped table-bordered" data-aos="fade-up" data-aos-duration="1000">
          ...
          <?php
							...
							$datas = mysqli_query($koneksi, "select * from dosen") or die(mysqli_error($koneksi));
            ...
            <tr>
              ...
              <td class="text-center">
                <a href="updatedosen.php?id=<?= $row['id']; ?>" class="btn btn-edit">Edit</a>
                <a href="deletedosen.php?id=<?= $row['id']; ?>" class="btn btn-hapus" onclick="return confirm('Hapus Data?');">Hapus</a>
              </td>
            </tr>
            <?php $no++; } ?>
          </tbody>
