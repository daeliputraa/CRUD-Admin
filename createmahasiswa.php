  ...
  <body>
    ...
    <div id="sidebar" class="row mt-5">
      ...
      <div id="mainbar" class="col-md-10 p-5 main-content">
        <h3 data-aos="fade-in" data-aos-duration="2000"><i class="bi bi-person-plus-fill"></i>Form Data Mahasiswa</h3>
        <hr />
        ...
        <form  action="" method="post" role="form" data-aos="fade-up" data-aos-duration="1000">
          ...
          <button type="submit" name="submit" value="simpan"><a class="btn btn-detail">Tambah Mahasiswa</a></button>
        ...
        <?php
				...
				if (isset($_POST['submit'])) {
					...
					$datas = mysqli_query($koneksi, "insert into mahasiswa (nama,npm,lahir,alamat) values('$nama', '$npm', '$lahir','$alamat')") or die(mysqli_error($koneksi));
